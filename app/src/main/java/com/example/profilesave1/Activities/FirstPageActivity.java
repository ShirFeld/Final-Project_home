...
import com.example.profilesave1.Fragments.recfragment;
        ...
        reference.child(userID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if(modelProfile != null){
                    ...
                    final TextView currName= (TextView) findViewById(R.id.headername);
                    final ImageView currImg= (ImageView) findViewById(R.id.imageProfile);
